...
async function fetchPosts(type, limit) {
  ...
  try {
    ...
    const res = await fetch(
      `/api/posts?type=${type}&limit=${limit || 20}`
    );
...
// Wraps a card's inner HTML in a link
      ...
      <div
        ...
        ${
          ...
          t.image
            ...
            : `<div class="no-image" style="font-size:9px;">
                ${t.title.slice(0, 2)}
              </div>`
